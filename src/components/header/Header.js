          ...
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <a href="#" className='flex'>
                <h2 className="text-2xl red font-bold">REACT JS</h2><span className='text-zinc-400 mt-2 text-sm pl-2'>mehrdad</span>
              </a>
            ...
            >
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0" style={{direction:'rtl'}}>
                ...
                <li className="text-white">
                  <Link to={"/Movies"}>
                    <span className="text flex">
                      <RiSlideshow3Line className='text-xl red ml-1 md:mr-4'/>دانلود سریال
                    </span>
                  </Link>
                </li>
                ...
                <li className="text-white">
                  <Link to={"/Movies"}>
                    <span className="text flex">
                      <HiUsers className='text-xl red ml-1 mr-1'/>هنرمندان
                    </span>
                  </Link>
                </li>
